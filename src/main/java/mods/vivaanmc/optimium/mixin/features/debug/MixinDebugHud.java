package mods.vivaanmc.optimium.mixin.features.debug;
...
public abstract class MixinDebugHud {
    ...
    private ArrayList<String> redirectRightTextEarly(Object[] elements) {
        ...
        strings.add("Renderer Version 0 (optimium Renderer)");
        strings.add(Formatting.UNDERLINE + getFormattedVersionText());

        var renderer = optimiumWorldRenderer.instanceNullable();
    ...
    private static String getFormattedVersionText() {
        String version = optimiumClientMod.getVersion();
        Formatting color;
