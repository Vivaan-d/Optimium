package mods.vivaanmc.optimium.mixin;

import mods.vivaanmc.optimium.common.config.Option;
import mods.vivaanmc.optimium.common.config.optimiumConfig;
...
public class optimiumMixinPlugin implements IMixinConfigPlugin {
    ...
    public void onLoad(String mixinPackage) {
        try {
            this.config = optimiumConfig.load(new File("./config/optimium-mixins.properties"));
        } catch (Exception e) {
            throw new RuntimeException("Could not load configuration file for optimium", e);
        }

        this.logger.info("Loaded configuration file for optimium: {} options available, {} override(s) found",
