package mods.vivaanmc.optimium.client.gui.screen;
...
public class ConfigCorruptedScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(32, this.height - 40, 174, 20, TEXT_BUTTON_RESTORE_DEFAULTS, (btn) -> {
            optimiumClientMod.restoreDefaultOptions();
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        drawTextWithShadow(matrices, this.textRenderer, Text.literal("optimium Renderer"), 32, 32, 0xffffff);
