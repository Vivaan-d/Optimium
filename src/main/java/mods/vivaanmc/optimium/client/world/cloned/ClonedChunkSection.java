...
import mods.vivaanmc.optimium.client.world.cloned.palette.ClonedPaletteFallback;
import mods.vivaanmc.optimium.client.world.cloned.palette.ClonedPalleteArray;
...
public class ClonedChunkSection {
    ...
    private void copyBlockEntities(WorldChunk chunk, ChunkSectionPos chunkCoord) {
        ...
        // See https://github.com/CaffeineMC/optimium-fabric/issues/942 for more info.
