...
import mods.vivaanmc.optimium.client.gl.arena.PendingUpload;
import mods.vivaanmc.optimium.client.gl.arena.staging.FallbackStagingBuffer;
...
import mods.vivaanmc.optimium.client.render.chunk.ChunkGraphicsState;
...
public class RenderRegionManager {
    ...
    private static StagingBuffer createStagingBuffer(CommandList commandList) {
        if (optimiumClientMod.options().advanced.useAdvancedStagingBuffers && MappedStagingBuffer.isSupported(RenderDevice.INSTANCE)) {
