...
import mods.vivaanmc.optimium.client.render.chunk.compile.ChunkBuilder;
import mods.vivaanmc.optimium.client.render.chunk.data.ChunkRenderData;
import mods.vivaanmc.optimium.client.render.chunk.format.ChunkModelVertexFormats;
import mods.vivaanmc.optimium.client.render.chunk.graph.ChunkGraphInfo;
import mods.vivaanmc.optimium.client.render.chunk.graph.ChunkGraphIterationQueue;
...
import mods.vivaanmc.optimium.client.render.chunk.region.RenderRegion;
import mods.vivaanmc.optimium.client.render.chunk.region.RenderRegionManager;
import mods.vivaanmc.optimium.client.render.chunk.tasks.ChunkRenderBuildTask;
import mods.vivaanmc.optimium.client.render.chunk.tasks.ChunkRenderEmptyBuildTask;
import mods.vivaanmc.optimium.client.render.chunk.tasks.ChunkRenderRebuildTask;
import mods.vivaanmc.optimium.client.util.MathUtil;
import mods.vivaanmc.optimium.client.util.frustum.Frustum;
...
import mods.vivaanmc.optimium.client.world.cloned.ClonedChunkSectionCache;
import mods.vivaanmc.optimium.common.util.DirectionUtil;
import mods.vivaanmc.optimium.common.util.collections.WorkStealingFutureDrain;
...
public class RenderSectionManager {
    ...
    private final optimiumWorldRenderer worldRenderer;
    ...
    public RenderSectionManager(optimiumWorldRenderer worldRenderer, BlockRenderPassManager renderPassManager, ClientWorld world, int renderDistance, CommandList commandList) {
    ...
    private void setup(Camera camera) {
        ...
        var options = optimiumClientMod.options();
    ...
    public Collection<String> getDebugStrings() {
        ...
        list.add(String.format("Chunk arena allocator: %s", optimiumClientMod.options().advanced.arenaMemoryAllocator.name()));
