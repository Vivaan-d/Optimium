package mods.vivaanmc.optimium.client.render;
...
import mods.vivaanmc.optimium.client.render.chunk.ChunkRenderMatrices;
import mods.vivaanmc.optimium.client.render.chunk.ChunkTracker;
import mods.vivaanmc.optimium.client.render.chunk.RenderSectionManager;
...
import mods.vivaanmc.optimium.client.render.pipeline.context.ChunkRenderCacheShared;
import mods.vivaanmc.optimium.client.util.NativeBuffer;
import mods.vivaanmc.optimium.client.util.frustum.Frustum;
import mods.vivaanmc.optimium.client.world.WorldRendererExtended;
import mods.vivaanmc.optimium.common.util.ListUtil;
 ...
 */
public class optimiumWorldRenderer {
    ...
    /**
     * @return The optimiumWorldRenderer based on the current dimension
     */
    public static optimiumWorldRenderer instance() {
    ...
    /**
     * @return The optimiumWorldRenderer based on the current dimension, or null if none is attached
     */
    public static optimiumWorldRenderer instanceNullable() {
        var world = MinecraftClient.getInstance().worldRenderer;

        if (world instanceof WorldRendererExtended) {
            return ((WorldRendererExtended) world).getoptimiumWorldRenderer();
        }

        return null;
    }

    public optimiumWorldRenderer(MinecraftClient client) {
        this.client = client;
    }
    ...
    public void updateChunks(Camera camera, Frustum frustum, @Deprecated(forRemoval = true) int frame, boolean spectator) {
        ...
        this.useEntityCulling = optimiumClientMod.options().performance.useEntityCulling;
