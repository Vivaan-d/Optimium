...
import mods.vivaanmc.optimium.client.gl.attribute.GlVertexAttributeBinding;
import mods.vivaanmc.optimium.client.gl.buffer.GlBufferUsage;
import mods.vivaanmc.optimium.client.gl.buffer.GlMutableBuffer;
import mods.vivaanmc.optimium.client.gl.device.CommandList;
import mods.vivaanmc.optimium.client.gl.device.DrawCommandList;
...
import mods.vivaanmc.optimium.client.gl.tessellation.GlPrimitiveType;
import mods.vivaanmc.optimium.client.gl.tessellation.GlTessellation;
import mods.vivaanmc.optimium.client.gl.tessellation.TessellationBinding;
import mods.vivaanmc.optimium.client.gl.util.ElementRange;
import mods.vivaanmc.optimium.client.gl.util.MultiDrawBatch;
...
import mods.vivaanmc.optimium.client.render.chunk.data.ChunkRenderBounds;
...
public class RegionChunkRenderer extends ShaderChunkRenderer {
    ...
    private final boolean isBlockFaceCullingEnabled = optimiumClientMod.options().performance.useBlockFaceCulling;
