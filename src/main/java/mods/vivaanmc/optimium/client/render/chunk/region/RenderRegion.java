package mods.vivaanmc.optimium.client.render.chunk.region;

import it.unimi.dsi.fastutil.objects.ObjectOpenHashSet;
import mods.vivaanmc.optimium.client.optimiumClientMod;
import mods.vivaanmc.optimium.client.gl.arena.AsyncBufferArena;
import mods.vivaanmc.optimium.client.gl.arena.GlBufferArena;
import mods.vivaanmc.optimium.client.gl.arena.SwapBufferArena;
import mods.vivaanmc.optimium.client.gl.arena.staging.StagingBuffer;
...
public class RenderRegion {
    ...
    public static class RenderRegionArenas {
        ...
        private static GlBufferArena createArena(CommandList commandList, int initialCapacity, StagingBuffer stagingBuffer) {
            return switch (optimiumClientMod.options().advanced.arenaMemoryAllocator) {
