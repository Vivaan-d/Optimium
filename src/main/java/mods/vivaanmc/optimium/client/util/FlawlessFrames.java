package mods.vivaanmc.optimium.client.util;
...
/**
 * Implements the "Flawless Frames" FREX feature using which third-party mods can instruct optimium to sacrifice
 ...
 *
 * In optimium's case, this means waiting for all chunks to be fully updated and ready for rendering before each frame.
 *
