...
Please read our [Contributor Guidelines](https://github.com/jellysquid3/optimium-fabric/blob/1.15.x/CONTRIBUTING.md) before
submitting any pull requests to this repository.

By submitting a pull request, you are indicating that you agree to the [Contributor License Agreement](https://github.com/jellysquid3/optimium-fabric/blob/1.15.x/CONTRIBUTING.md#contributor-license-agreement-cla)
